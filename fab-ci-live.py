...
REPO_URL = 'git@github.com:k-oneGene/bodt-cms.git'

env.hosts = ['www.bachatacambridge.com']
env.user = 'jin'
...
def _restart_gunicorn():
    run('sudo systemctl restart gunicorn-www.bachatacambridge.com.service')
